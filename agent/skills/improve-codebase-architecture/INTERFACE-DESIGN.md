...
When the user wants to explore alternative interfaces for a chosen deepening candidate, produce multiple independent designs sequentially. Based on "Design It Twice" (Ousterhout) — your first idea is unlikely to be the best.
...
Produce 3+ **radically different** interfaces for the deepened module. Work from the original brief each time rather than incrementally tweaking the previous design.
